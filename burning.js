...
async function load(){
      ...
      button_RUB.onclick = function(){
            window.location = `burning_tours.php?pain=${test.RUB}&znak=₽`;  
      }
      button_UAH.onclick = function(){
            window.location = `burning_tours.php?pain=${test.UAH}&znak=₴`;  
      }
      button_USD.onclick = function(){
            window.location = `burning_tours.php?pain=${test.USD}&znak=$`;  
      }
